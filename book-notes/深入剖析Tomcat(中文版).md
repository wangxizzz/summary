...
20.**类加载器的类型：**  
参考网址：http://www.importnew.com/6581.html

总结一下，下面是三种类加载器加载类文件的地方：

1) Bootstrap类加载器 – 在JRE/lib/rt.jar搜索需要加载的类，会加载Java核心类，java.lang,java.io
...
看下视频与百度云教程，看是否能找到比较好的实现Tomcat容器的例子;

Tomcat的面试题与问题答案解析（先解决之前遗留的问题，然后上牛客网上收集）。
